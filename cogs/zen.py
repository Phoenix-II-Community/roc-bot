...
class ZenCog(commands.Cog, group_name="zen"):
    ...
    @zen.command(
        name="all", description="All zens in the game", help="All zens in the game"
    )
    @commands.guild_only()
    ...
    @zen.command(
        name="list",
        help="All the ships with that Zen",
        description="All the ships with that Zen",
    )
    @commands.guild_only()
    ...
    @zen.command(
        name="info", help="List the zen damage types and their characteristics"
    )
    @commands.guild_only()
